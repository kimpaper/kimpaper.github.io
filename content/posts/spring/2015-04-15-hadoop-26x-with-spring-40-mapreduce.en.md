---
layout: post
title: hadoop + spring integration test 2 - hadoop 2.6.x with spring 4.0 (MapReduce WordCount example)
date: '2015-04-15T00:39:00'
author: Paper
categories: spring
tags: [hadoop,spring]
url: /en/2015/04/15/2-hadoop-26x-with-spring-40-mapreduce/
---

#### Add the following to context-hadoop.xml. 
```xml
...
1. In Before, copy the local debug.log file into hdfs.   
2. Run the job.  
3. Once it runs, you can see the debug.log file being read line by line. (WordCount$TokenizerMapper)  
